...
- **PayPal API:** Payment gateway integration for secure transactions.
...
1. **Clone the repository:**
   ...
   ```bash
   git clone git@github.com:ydvprbn/django-ecommerce-project.git
...
- First, make sure your virtual environment is activated, it should be something like that - `(venv) PS C:\Users\ydvprbn\django-ecommerce-project`)-

- Second, you should create `.env` file in your project root, and update it.
...
- **Shopping:** Browse products, add items to the cart, proceed to checkout, and make payments using PayPal.
